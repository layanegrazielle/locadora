...
public class editarVeiculoVIEW extends javax.swing.JFrame {
    ...
    public editarVeiculoVIEW() {
       ...
       public editarVeiculoVIEW(int idLocadora) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(editarVeiculoVIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new editarVeiculoVIEW().setVisible(true);
            }
        });
    }
...
public void carregarVeiculo(int id){
    ...
    veiculo = locadora.buscarVeiculo(id);
    
    txtId.setText(String.format("%d", veiculo.getId()));
    txtMarca.setText(veiculo.getMarca());
    txtModelo.setText(veiculo.getModelo());
    txtAno.setText(veiculo.getAno());
    txtCategoria.setText(veiculo.getCategoria());
...
public void editarVeiculo(){
    ...
    int id;
        ...
        LocadoraDAO locadora = new LocadoraDAO();
        locadora.editarVeiculo(veiculo);
